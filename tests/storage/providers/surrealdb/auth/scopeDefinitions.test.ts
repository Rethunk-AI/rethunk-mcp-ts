...
describe('ScopeDefinitions', () => {
  describe('apiJwt', () => {
    ...
    it('should support all JWT algorithms', () => {
      ...
      for (const algorithm of algorithms) {
        const config = ScopeDefinitions.apiJwt('secret', 'test', algorithm)
  ...
  describe('userAuth', () => {
    it('should create record config with defaults', () => {
      const config: RecordAccessConfig = ScopeDefinitions.userAuth('jwt-secret')
    ...
    it('should use email and password as default fields', () => {
      const config = ScopeDefinitions.userAuth('secret', 'user_access', 'user')
  ...
  describe('adminAuth', () => {
    it('should create admin record config with defaults', () => {
      const config: RecordAccessConfig =
        ScopeDefinitions.adminAuth('admin-secret')
